...
const AllSellers = () => {
  ...
  useEffect(() => {
    axios
      .get("https://second-hand-phone-server.vercel.app/lists/seller")
  ...
  const handleDeleteSeller = (seller) => {
    ...
    fetch(`https://second-hand-phone-server.vercel.app/users/${seller._id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleVerifySeller = (seller) => {
    ...
    fetch(`https://second-hand-phone-server.vercel.app/sellers/${seller._id}`, {
      method: "PATCH",
      headers: {
          ...
          <tbody>
            {sellers.map((seller, i) => (
              <tr key={i}>
                ...
                <td>
                  {seller?.sellerVerified ? (
                    <button className="btn btn-primary btn-disabled">Verified</button>
                  ) : (
                    <button
                ...
                <td>
                  <button onClick={() => handleDeleteSeller(seller)} className="btn btn-warning">
                    Delete
                  </button>
                </td>
              </tr>
